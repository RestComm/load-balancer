...
Currently the Load balancer support two protocols for heartbeats(RMI and protocol
based on http requests). For setup you should
set property <nodeCommunicationProtocolClassName></nodeCommunicationProtocolClassName>
in <common> section.
...
<common>
  ...
  <nodeCommunicationProtocolClassName>org.mobicents.tools.heartbeat.impl.ServerController</nodeCommunicationProtocolClassName>
...
<http>
  <httpPort>2080</httpPort>
  <httpsPort>2081</httpsPort>
  <maxContentLength>2097152</maxContentLength>
...
nodeCommunicationProtocolClassName::
