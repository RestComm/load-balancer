 ...
 */
public abstract class DefaultSmppAlgorithm implements SmppAlgorithm{
	...
	public void setBalancerContext(BalancerContext balancerContext)
	{
		this.balancerContext = balancerContext;
	}
