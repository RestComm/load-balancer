 ...
 */
public class DeleteConnectionFromCaWithConnectionIdTest {

	private static Logger logger = Logger.getLogger(DeleteConnectionFromCaWithConnectionIdTest.class);
    ...
    { 
		...
		server2.sendNotify();
		sleep(1000);
		ca.sendDeleteConnectionWithConnection();
		sleep(1000);
		ca.sendDeleteConnectionWithConnection();
		sleep(1000);
		ca.sendDeleteConnectionWithConnection();
