 ...
 */
public class DeleteConnectionFromCaWithCallIdTest {

	private static Logger logger = Logger.getLogger(DeleteConnectionFromCaWithCallIdTest.class);
    ...
    { 
		...
		server2.sendNotify();
		sleep(1000);
		ca.sendDeleteConnectionWithCall();
		sleep(1000);
		ca.sendDeleteConnectionWithCall();
		sleep(1000);
