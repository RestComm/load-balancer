 ...
 */
public class DeleteConnectionFromMgwWithConnectionIdTest {

	private static Logger logger = Logger.getLogger(DeleteConnectionFromMgwWithConnectionIdTest.class);
    ...
    { 
		...
		server1.sendNotify();
		sleep(1000);
		server1.sendDeleteConnectionWithConnection();
		sleep(1000);
		server1.sendDeleteConnectionWithConnection();
		sleep(1000);
		server1.sendDeleteConnectionWithConnection();
