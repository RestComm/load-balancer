 ...
 */
public class DeleteConnectionFromMgwWithCallIdTest {

	private static Logger logger = Logger.getLogger(DeleteConnectionFromMgwWithCallIdTest.class);
    ...
    { 
		...
		server1.sendNotify();
		sleep(1000);
		server1.sendDeleteConnectionWithCall();
		sleep(1000);
		server1.sendDeleteConnectionWithCall();
		sleep(1000);
