 ...
 */
public class DeleteConnectionFromMgwWithEndpointIdTest {

	private static Logger logger = Logger.getLogger(DeleteConnectionFromMgwWithEndpointIdTest.class);
    ...
    { 
		...
		server1.sendNotify();
		sleep(1000);
		server1.sendDeleteConnectionWithEnpoint();
		sleep(1000);
		server1.sendDeleteConnectionWithEnpoint();
		sleep(1000);
