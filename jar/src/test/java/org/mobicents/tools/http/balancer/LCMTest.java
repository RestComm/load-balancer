...
import org.mobicents.tools.sip.balancer.LCMPersistentConsistentHashBalancerAlgorithm;
...
public class LCMTest {
	...
	private static String [] instanceId = {"ID1f2a2222772f4195948d040a2ccc641c",
		"ID1f2a2222772f4195948d040a2ccc648c",
		"ID1f2a2222772f4195948d040a2ccc643c"};
	...
	public static void initialization() 
	{
		...
		{
			serverArray[i] = new HttpServer(8080+i, 4444+i, instanceId[i]);
			serverArray[i].start();	
		}
		...
		lbConfig.getSipConfiguration().getAlgorithmConfiguration().setAlgorithmClass(LCMPersistentConsistentHashBalancerAlgorithm.class.getName());
		...
		.setPersistentConsistentHashCacheConfiguration(LCMPersistentConsistentHashBalancerAlgorithm.class.getClassLoader().getResource("infinispan-cache.xml").getFile());
		...
		public void run()
		{
			...
			{ 
				...
				WebRequest request = new PostMethodWebRequest(
						"http://user:password@127.0.0.1:2080/restcomm/2012-04-24/Accounts/"+accountSid+"/Calls/ID1f2a2222772f4195948d040a2ccc648c-CA00af667a6a2cbfda0c07d923e78194cd");
