...
public class AdvancedSmppServer extends DefaultSmppServer {

	private static final Logger logger = LoggerFactory.getLogger(AdvancedSmppServer.class);
	
	public AdvancedSmppServer(SmppServerConfiguration configuration, SmppServerHandler serverHandler, 
