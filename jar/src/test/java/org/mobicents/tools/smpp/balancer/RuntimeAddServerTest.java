...
import org.mobicents.tools.http.balancer.UrlRewriteTest;
...
public class RuntimeAddServerTest{
	
	private static final Logger logger = LoggerFactory.getLogger(RuntimeAddServerTest.class);
	...
	@Test
	public void testAddingServerInRuntime() 
    {
		int clientNumbers = 1;
	    ...
	    for(DefaultSmppServerHandler serverHandler:serverHandlerArray)
	    	assertEquals(2, serverHandler.smsNumber);
	...
	private class Load extends Thread{
		...
		public void run()
		{
			...
			try
			{
			 ...
			 lines.set(72, "  <remoteServers>127.0.0.1:10021,127.0.0.1:10022</remoteServers>");
