...
public class InvalidPasswordTest {
	...
	private static final Logger logger = LoggerFactory.getLogger(InvalidPasswordTest.class);
	...
	@Test
	public void testBindWithIncorrectPassword() {
	...
	private class Load extends Thread {
		...
		public void run() {
			...
			try 
			{
				...
				sessionConfig.setPassword("invalidPassword");
